...
import { 
  ...
  VStack, 
  HStack, // ✨ Importado para alinear los botones horizontalmente
  Box, 
  Link,
  useColorModeValue,
  Text,
...
interface CourseEvaluationFormProps {
  ...
  rubricaUrl: string; 
  protocoloUrl: string; // ✨ Propiedad inyectada
...
export function CourseEvaluationForm({ 
  ...
  rubricaUrl,
  protocoloUrl, // ✨ Propiedad desestructurada
  onFileChange,
  ...
  return (
    ...
    >
      ...
      <Box pb={4} borderBottom="1px" borderColor={useColorModeValue('gray.100', 'gray.700')} w="full">
        <Text mb={3} fontWeight="bold" fontSize="lg" textAlign="left">Documentos de Referencia:</Text>
        
        {/* ✨ Contenedor horizontal para que los botones no se aplasten */}
        <HStack spacing={4} wrap="wrap">
            ...
            >
                <InfoButton 
                    leftIcon={<DownloadIcon />}
                    size="lg" 
                >Descargar Protocolo</InfoButton>
            </NextLink>
        </HStack>
      </Box>
